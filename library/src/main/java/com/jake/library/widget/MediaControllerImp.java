 ...
 * @since 2016/10/29 23:54
 */


public class MediaControllerImp implements MediaController.MediaPlayerControl {
    ...
    private static final String TAG = MediaControllerImp.class.getSimpleName();
